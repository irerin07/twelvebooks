...
insert into users(id, email ,name, comment,  passwd, regdate) values (100, 'counterchord99@gmail.com'. '임경수', '만나서 반가워요', 359751, now());
...
insert into roles_has_users(user_id, role_id) values (3, 2);
insert into roles_has_users(user_id, role_id) values (4, 2);
insert into roles_has_users(user_id, role_id) values (5, 2);
insert into roles_has_users(user_id, role_id) values (6, 2);
insert into roles_has_users(user_id, role_id) values (7, 2);
insert into roles_has_users(user_id, role_id) values (8, 2);
insert into roles_has_users(user_id, role_id) values (9, 2);
insert into roles_has_users(user_id, role_id) values (10, 2);

insert into challenges(id, start_date, end_date, days, visibility, finished, status, users_id, books_id) values(1, '2019-03-25 23:59:59', '2019-04-23 23:59:59',30, 1,  '읽는중', 1, 1);
insert into challenges(id, start_date, end_date, days, visibility, finished, status, users_id, books_id) values(1, '2019-03-26 23:59:59', '2019-04-24 23:59:59',30, 1,  '읽는중', 2, 2);
insert into challenges(id, start_date, end_date, days, visibility, finished, status, users_id, books_id) values(1, '2019-03-27 23:59:59', '2019-04-25 23:59:59',30, 0,  '읽는중', 3, 3);
insert into challenges(id, start_date, end_date, days, visibility, finished, status, users_id, books_id) values(1, '2019-03-28 23:59:59', '2019-04-26 23:59:59',30, 1,  '읽는중', 4, 4);
insert into challenges(id, start_date, end_date, days, visibility, finished, status, users_id, books_id) values(1, '2019-03-29 23:59:59', '2019-04-27 23:59:59',30, 1,  '읽는중', 5, 5);

insert into diaries(id, day, content, users_id, challenges_id) values(1, 1, '자바 존나 어렵네', 1, 1);
insert into diaries(id, day, content, users_id, challenges_id) values(2, 1, '자바 갑나 어렵네', 2, 2);
insert into diaries(id, day, content, users_id, challenges_id) values(3, 1, '자바 지젼 어렵네', 3, 3);
insert into diaries(id, day, content, users_id, challenges_id) values(4, 1, '자바 어렵네', 4, 4);
insert into diaries(id, day, content, users_id, challenges_id) values(5, 1, '자바 존나 쉽네', 5, 5);