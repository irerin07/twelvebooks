...
insert into diaries(id, day, content, user_id, challenge_id) values(4, 1, '자바 어렵네', 4, 4);
insert into diaries(id, day, content, user_id, challenge_id) values(5, 1, '자바 존나 쉽네', 5, 5);